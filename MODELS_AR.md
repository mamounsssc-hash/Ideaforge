...
## 🟢 الأسهل الآن — زر داخل التطبيق نفسه (موصى به)

1. شغّل التطبيق عادي بـ `START.bat` (سيفتح المتصفح على `http://127.0.0.1:8000`).
2. لو النموذج غير محمّل، سيظهر **بانر أصفر في أعلى الصفحة** مكتوب عليه *"Speech model needed"* وبجانبه زر **⬇ Download model**.
3. اضغط الزر. سيبدأ التحميل ويظهر **شريط تقدّم بنسبة مئوية** داخل الصفحة. اترك الصفحة مفتوحة.
4. عند الانتهاء يتحوّل البانر إلى أخضر *"✓ Speech model ready"* ثم يختفي. أنت جاهز — لا حاجة لإعادة تشغيل.

> لا أوامر، لا ملفات، لا شيء خارج التطبيق. كل شيء بزر واحد من المتصفح.

---

## 🖱️ طريقة أخرى — ملف تضغط عليه ضغطتين (معك إنترنت)
