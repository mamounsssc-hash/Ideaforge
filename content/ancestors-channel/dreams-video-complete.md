# Dreams Video — Complete Production Guide (210 Frames)

**Video:** "What Did Ancient Humans Think Dreams Were?"
**Character:** Simple stickman (Zenn style, no custom character)
...
# PART 2: IMAGE PROMPTS (210 Frames)
...
Stickman head (same as Prompt #4). Brain inside with small faded images and a circular replay arrow ♻. Text: "RESIDUES — REPLAY". [WHITE SUFFIX]
...
A stickman with glasses (RESEARCHER variant, same as Prompt #29). Text: "ANTTI REVONSUO", "UNIVERSITY OF TURKU, FINLAND", "2000". [GREEN SUFFIX]
...
### Prompt #172 — "Egypt"
Pyramid silhouettes in background. A stickman with golden triangular headdress (Pharaoh variant, same as Prompt #87) lying on bed, dreaming. Dream cloud above. Text: "EGYPT". [WHITE SUFFIX]

### Prompt #173 — "Athens"
Greek column in background. A stickman with beard (same as Prompt #65 Heraclitus style) seated on stone, thinking pose (hand on chin), looking at dream cloud. Text: "ATHENS". [WHITE SUFFIX]

### Prompt #174 — "Chicago"
Modern building outline. A stickman with glasses (RESEARCHER, same as Prompt #29) looking at screen showing brain scan data. Text: "CHICAGO". [WHITE SUFFIX]

### Prompt #175 — "Nobody ever"
A stickman in SHRUG pose (shoulders raised, palms up). Text: "DREAMS DON'T MATTER?" LARGE RED X crossing out entire scene. Text: "NOBODY. EVER." [WHITE SUFFIX]
...
A stickman (same as Prompt #1) stepping through a glowing purple portal/doorway. One foot in white background, one foot in purple dream space. Text: "ABSOLUTELY REAL". [WHITE SUFFIX]
